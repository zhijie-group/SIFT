...
class GenInferencerOutputHandler:
    ...
    def save_results(self, origin_prompt, prediction, idx, gold=None, reasoning_content=None, total_token_len=None, input_token_len=None): ##########
        ...
        if reasoning_content: ##########
            self.results_dict[str(idx)]['reasoning_content'] = reasoning_content ##########
        if total_token_len: ##########
            self.results_dict[str(idx)]['total_token_len'] = total_token_len ##########
        if input_token_len: ##########
            self.results_dict[str(idx)]['input_token_len'] = input_token_len ##########
