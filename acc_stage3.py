...
parser.add_argument('--stage3res', type=str, help='Path to the output JSONL file')
...
stage3res = parser.parse_args().stage3res
        ...
        if evaluator_v2.is_equiv(gsm8k_final2[i]['pred_v2'], gsm8k_final3[i]['pred_v2']):
            ...
            for j in range(len(gsm8k_final5)):
                ...
                if gsm8k_final1_question in gsm8k_final6[j]['question']:
                    ...
                    input_token_len += gsm8k_final5[j]['input_token_len']
                    input_token_len += gsm8k_final6[j]['input_token_len']
                    input_token_len += gsm8k_final7[j]['input_token_len']
                    ...
                    if evaluator_v2.is_equiv(gsm8k_final5[j]['pred_v2'], gsm8k_final6[j]['pred_v2']):
                        ...
                        f.write(json.dumps({
                            "prediction": gsm8k_final6[j]['prediction'],
                            "question": gsm8k_final1_question,
